...
# dark theme figure for presentations showing mass standardization of SMR
...
# figure showing SGR (2 month) vs. mass standardized SMR
ggplot(data[which(data$ds == "B1"),], aes(x = lead(SGR_2m), y = SMR_mass, colour = factor(Temp), fill = factor(Temp))) +
  geom_point() +
  geom_smooth(method = "lm", se = T, aes(fill = factor(Temp))) +
  theme_bw() +
...
# dark theme figure for presentations showing SGR vs. SMR
ggplot(data[which(data$ds == "B1"),], aes(x = lead(SGR_2m), y = SMR_mass, colour = factor(Temp), fill = factor(Temp))) +
  geom_point(size = 2) +
  geom_smooth(method = "lm", se = T, aes(fill = factor(Temp))) +
