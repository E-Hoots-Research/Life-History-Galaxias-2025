...
ds <- read.csv("C:/Users/s222141733/OneDrive - Deakin University/Beth Hoots/Chapter 3/workingtable.csv") # read in data table
...
B1_gut <- read.csv("C:/Users/s222141733/OneDrive - Deakin University/Beth Hoots/Chapter 2 (2023 Growth Performance)/Analysis/Metadata/Otoliths and biometrics/GutRatio.csv")
...
```{r}
ds2 <- read.csv("C:/Users/s222141733/OneDrive - Deakin University/Beth Hoots/Chapter 1 (growth performance pilot)/Results/Processed/Ch3_ds2.csv")
...
ds3 <- read_excel("C:/Users/s222141733/OneDrive - Deakin University/Beth Hoots/Chapter 2 (2023 Growth Performance)/Analysis/Mike datasets/stomach_size_vs_gonad_mass.xlsx", sheet = "Beth Normoxia Only")
...
Gut ratio really does not seem to have any correlation with mass-standardized SMR (any correlation seen between gut ratio and SMR could be explained by mass). Note that this figure uses the previously extrapolated values (above). For MMR, the case is a bit more complicated, as there seems to be a positive relationship between
...
lm_SMR <- lmer(log10(SMR) ~ log_mass*factor(Temp), data = data)
